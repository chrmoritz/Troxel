...
class ZoxelIO extends IO
  constructor: (file, callback) ->
    ...
    fr.onloadend = =>
      ...
      {"creator": c, "height": @x, "width": @y, "depth": @z, "version": v, "frames": frames} = data
      ...
      for f in [1..frames] by 1
        ...
        for [x, y, z, c] in data["frame#{f}"]
          ...
          @voxels[z][y][x] = {r: (c & 0xff000000) >>> 24, g: (c & 0x00ff0000) >>> 16, b: (c & 0x0000ff00) >>> 8, a: (c & 0x000000ff), t: 0, s: 0}
      console.log "voxels:"
      console.log @voxels
      callback()
  ...
  export: ->
    ...
    json = {creator: "Troxel", height: @x, width: @y, depth: @z, version: 1, frames: 1, frame1: frame}
